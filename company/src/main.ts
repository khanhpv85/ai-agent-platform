...
async function bootstrap() {
  ...
  const config = new DocumentBuilder()
    .setTitle('AI Agent Platform - Company Service')
    .setDescription('Company, workflow, and agent management service for the AI Agent Platform')
    .setVersion('1.0')
    .addBearerAuth()
    .addServer('http://localhost:3002', 'Direct Service Access')
    .build();
